...
public class ViewContacts extends AppCompatActivity implements ContactListAdapter.ContactItemInterface {

    ListView listView;
    DatabaseHandler db;
    ArrayList<Pair<String, String>> contactList;
    ContactListAdapter contactListAdaptor;
    ...
    public void updateListView() {
        ...
        if (cursor.getCount() == 0) {
            ...
            contactListAdaptor = new ContactListAdapter(this, contactList, this);
    ...
    public void search(String keyword) {
        ...
        if (cursor.getCount() == 0) {
            ...
            contactListAdaptor.clear();
            contactList.add(contact);
            contactListAdaptor = new ContactListAdapter(ViewContacts.this, contactList, null);
            listView.setAdapter(contactListAdaptor);
        } else {
            contactListAdaptor.clear();
            while (cursor.moveToNext()) {
            ...
            contactListAdaptor = new ContactListAdapter(ViewContacts.this, contactList, ViewContacts.this);
            listView.setAdapter(contactListAdaptor);
        }
    }
}
