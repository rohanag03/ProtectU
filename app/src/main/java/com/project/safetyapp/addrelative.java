...
public class addrelative extends AppCompatActivity {
    ...
    Button add , contacts ;
    com.project.safetyapp.DatabaseHandler db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new com.project.safetyapp.DatabaseHandler(this);
        ...
        contacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cursor.getCount() == 0){
                    ...
                    startActivity(new Intent(addrelative.this, com.project.safetyapp.ViewContacts.class));
                }
